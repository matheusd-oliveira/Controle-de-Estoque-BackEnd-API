...
namespace ControleDeEstoqueApi.Domain.Models.InterfacesRepositories
{
    public interface IGerenteRepository
    {
        ...
        public Task<Venda> CancelarVenda(int id); // Cancelar venda através do codigo da venda.
        ...
        public Task<IEnumerable<Funcionario>> ListarFuncionarios(string nomeDoFuncionario);
        ...
        public Task<IEnumerable<Fornecedor>> ListarFornecedores(string nomeDoFornecedor);
        ...
        public Task<IEnumerable<Fabricante>> ListarFabricantes(string nomeDoFabricante);
