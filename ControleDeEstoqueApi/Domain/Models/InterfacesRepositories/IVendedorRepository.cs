...
namespace ControleDeEstoqueApi.Domain.Models.InterfacesRepositories
{
    public interface IVendedorRepository
    {
        ...
        // Manter Vendas
        public Task<Venda> EfetuarVenda(Venda venda); // OK
        public Task AdicionarItemDeVenda(Item_Venda itemDaVenda); // OK - Adicionar item da venda na Venda.
        public Task CancelarItemDeVenda(Item_Venda itemDaVenda); // OK - Cancelar item da venda através do codigo do item , que é UNIQUE.
        public Task<IEnumerable<Estoque>> ListarProdutosPorNomeNaTelaDeVenda(string nomeDoProduto); // OK - Listar todos os produtos através do nome na tela Venda.
