...
namespace ControleDeEstoqueApi.Infrastructure.Repositories
{
    public class GerenteRepository : IGerenteRepository
    {
        ...
        // TODO
        public async Task<IEnumerable<Funcionario>> ListarFuncionarios(string nomeDoFuncionario)
        {
            return await _dbConnection.Funcionario.Where(funcionario => funcionario.nome_do_funcionario == nomeDoFuncionario).ToListAsync();
        }
        ...
        // TODO
        public async Task<IEnumerable<Fornecedor>> ListarFornecedores(string nomeDoFornecedor)
        {
            return await _dbConnection.Fornecedor.Where(fornecedor => fornecedor.nome_fantasia_do_fornecedor == nomeDoFornecedor).ToListAsync();
        }
        ...
        // TODO
        public async Task<IEnumerable<Fabricante>> ListarFabricantes(string nomeDoFabricante)
        {
            return await _dbConnection.Fabricante.Where(fabricante => fabricante.nome_do_fabricante == nomeDoFabricante).ToListAsync();
        }
    }
}
